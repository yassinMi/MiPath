        ...
        if (locationInfo) {
            switch (locationInfo.pageType) {
                ...
                case "home":
                    ...
                    break;
                case "projectOverview":
                    document.title = `${locationInfo.projectName} - Path`
                    break;
                case "projectTasks":
                    document.title = `Tasks of '${locationInfo.projectName}' - Path`
                    break;
                case "projects":
                    document.title = `Projects - Path`
                    break;
                case "tasks":
                    document.title = `Tasks - Path`
                    break;
                case "thisweekOverview":
                    document.title = `This Week - Path`
                    break;
                case "todayOverview":
                    document.title = `Today - Path`
                    break;
                default:
                    break;
            }
