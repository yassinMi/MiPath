...
import { Button, ButtonGroup, Menu, MenuItem, ToggleButton, ToggleButtonGroup } from "@mui/material";
...
const options = ["Create Project", "Create Task", "Create Event"];
 ...
 useEffect(() => {
    ...
    return (
        ...
        <div className="text-gray-800 dark:text-gray-200">
               <div  className="projects-control-panel shadow-2xl   z-50 dark:bg-gray-900 bg-white h-12  rounded p-4 flex flex-row gap-4 items-center shadow m-4">
  <ToggleButtonGroup
      value={viewMode}
      exclusive
